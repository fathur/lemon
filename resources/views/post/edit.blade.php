...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <form class="form-horizontal" action="{{route('posts.update', $post->id)}}" method="post" role="form">
                {{csrf_field()}}
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="active" value="1" @if($post->active)checked="checked"@endif> Active
                            </label>
                        </div>
                    </div>
                </div>
